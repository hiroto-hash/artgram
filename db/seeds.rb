lady = Category.create(name: "イラストレーション")
lady_1 = lady.children.create(name: "Adobe Illustrator")
# lady_1.children.create([{name: ""},{name: "Tシャツ/カットソー(七分/長袖)"},{name: "シャツ/ブラウス(半袖/袖なし)"},{name: "シャツ/ブラウス(七分/長袖)"},{name: "ポロシャツ"},{name: "キャミソール"},{name: "タンクトップ"},{name: "ホルターネック"},{name: "ニット/セーター"},{name: "チュニック"},{name: "カーディガン/ボレロ"},{name: "アンサンブル"},{name: "ベスト/ジレ"},{name: "パーカー"},{name: "トレーナー/スウェット"},{name: "ベアトップ/チューブトップ"},{name: "ジャージ"},{name: "その他"}])
lady_2 = lady.children.create(name: "Affinity Designer")
...
lady_3 = lady.children.create(name: "Canvas (グラフィックソフト)")
...
lady_7 = lady.children.create(name: "Painter Essentials")
# lady_7.children.create([{name: "絵本"}])
lady_8 = lady.children.create(name: "Template:イラストレーション")
# lady_8.children.create([{name: "ソックス"},{name: "スパッツ/レギンス"},{name: "ストッキング/タイツ"},{name: "レッグウォーマー"},{name: "その他"}])
lady_9 = lady.children.create(name: "口絵")
# lady_9.children.create([{name: "ニットキャップ/ビーニー"},{name: "ハット"},{name: "ハンチング/ベレー帽"},{name: "キャップ"},{name: "キャスケット"},{name: "麦わら帽子"},{name: "その他"}])
lady_10 = lady.children.create(name: "似顔絵")
...
lady_11 = lady.children.create(name: "Pixiv")
...
# メンズ
men = Category.create(name: "浮世絵")
men_1 = men.children.create(name: "藍摺")
...
men_2 = men.children.create(name: "アイヌ絵")
...
men_3 = men.children.create(name: "浮絵")
...
# ベビー・キッズ
# baby_kids = Category.create(name: "絵図")
# baby_kids_1 = baby_kids.children.create(name: "切絵図")
...
# インテリア・住まい・小物
interior_residence_accessory = Category.create(name: "切り絵")
...
# 本・音楽・ゲーム
book_music_game = Category.create(name: "寓意画")
# book_music_game_1 = book_music_game.children.create(name: "絵画芸術 (フェルメールの絵画)")
...
# おもちゃ・ホビー・グッズ
toy_hobby_goods = Category.create(name: "少女画")
...
# コスメ・香水・美容
cosme_perfume_beauty = Category.create(name: "水墨画")
...
# 家電・スマホ・カメラ
appliance_smartphone_camera = Category.create(name: "風景画")
...
# スポーツ・レジャー
sport_leisure = Category.create(name: "ポスター")
...
# チケット
ticket = Category.create(name: "コンピューターグラフィックス")
...
# 自動車・オートバイ
car_motorcycle = Category.create(name: "肖像画")
